    ...
    memory = Memory.from_config(
        {
            ...
            "llm": {
                ...
                "config": {
                    ...
                    "openai_base_url": os.environ["BENCH_BASE_URL"],
...
def main() -> None:
    ...
    print(f"\n{len(samples)} conversations, {stored} turns, {asked} evidence-labelled questions")
    print("Metric: is the gold evidence turn in the top-k — independent of storage form\n")
