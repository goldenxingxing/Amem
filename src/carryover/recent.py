...
class SessionSummary(BaseModel):
    ...
    Written whenever a conversation is compacted or ends, and read back into
    the opening context of the next one as a short reminder of what happened
    before. Who writes it is the host's business; this is the shape.
    """
        ...
        with open(path, encoding="utf-8") as f:
            for line in f:
                ...
                try:
                    ...
                    logger.warning("skipping malformed summary line in %s: %s", path, e)
    except OSError as e:
